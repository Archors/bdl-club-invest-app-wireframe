...
const navItems = [
  ...
  },
  {
    ...
    label: 'Le Club',
    icon: (
      <svg width="22" height="14" viewBox="0 0 146 90" fill="none">
        {/* Silhouette extérieure des créneaux uniquement */}
        <path d="M7.6,38 C1.5,35.6 -0.3,30.8 0,23.7 L0.18,12.22 C0.65,7.47 3.11,3.63 8.01,3.06 C14.8,2.3 15.3,1.7 22.1,1.25 V18.68 H35.7 V0.52 C42.8,0.22 54.1,0 62.3,0 V18.66 H84.3 V0 C92.5,0.06 103.8,0.24 110.7,0.52 V18.68 H124.3 V1.27 C131.1,1.71 131.2,2.31 138,3.07 C143,3.63 145.4,7.49 145.83,12.24 L145.96,23.72 C146.32,30.79 144.56,35.67 137.81,37.95 Z" stroke="currentColor" strokeWidth="5" strokeLinejoin="round"/>
        {/* Corps */}
        <path d="M134.677 42.1266H11.4449C15.5647 49.1557 19.7314 62.9288 19.5904 68.4538C19.4495 73.9789 21.0316 76.1636 24.0548 77.7942C25.2565 78.3372 26.5113 78.751 27.7986 79.029H118.339C119.626 78.751 120.881 78.3372 122.083 77.7942C125.09 76.2111 126.782 73.9314 126.531 68.4538C126.281 62.9763 130.573 49.1557 134.677 42.1266Z" stroke="currentColor" strokeWidth="5" strokeLinejoin="round"/>
        {/* Base */}
        <path d="M23.2716 82.7177H122.584L122.114 90H23.2716V82.7177Z" stroke="currentColor" strokeWidth="5" strokeLinejoin="round"/>
      </svg>
    ),
    iconFilled: (
      <svg width="22" height="14" viewBox="0 0 146 90" fill="none">
        <path fillRule="evenodd" clipRule="evenodd" d="M134.677 42.1266H11.4449C15.5647 49.1557 19.7314 62.9288 19.5904 68.4538C19.4495 73.9789 21.0316 76.1636 24.0548 77.7942C25.2565 78.3372 26.5113 78.751 27.7986 79.029H118.339C119.626 78.751 120.881 78.3372 122.083 77.7942C125.09 76.2111 126.782 73.9314 126.531 68.4538C126.281 62.9763 130.573 49.1557 134.677 42.1266Z" fill="currentColor"/>
        <path fillRule="evenodd" clipRule="evenodd" d="M145.955 23.715L145.83 12.2375C145.391 7.48812 142.948 3.62533 137.998 3.07124C131.231 2.31135 131.105 1.70977 124.323 1.2665V18.6807H110.726V0.52243C103.771 0.23747 92.5083 0.0633245 84.2688 0V18.6649H62.3387V0C54.0992 0 42.8051 0.221639 35.7091 0.52243V18.6649H22.1124V1.25065C15.3297 1.69392 14.7972 2.2955 8.01447 3.0554C3.11151 3.60949 0.652189 7.45647 0.182257 12.2216L0.0412392 23.6992C-0.303378 30.7757 1.45105 35.6201 7.60716 37.9472C7.83019 38.017 8.03767 38.1299 8.21807 38.2797H137.81C137.987 38.1332 138.188 38.0205 138.405 37.9472C144.561 35.6675 146.316 30.7915 145.955 23.715Z" fill="currentColor"/>
        <path fillRule="evenodd" clipRule="evenodd" d="M122.114 90H23.2716L22.316 82.7177H122.584L122.114 90Z" fill="currentColor"/>
      </svg>
    ),
  },
  {
